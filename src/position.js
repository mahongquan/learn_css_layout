...
<figure className="highlight"><Highlight>{`.static {
  position: static;
}`}</Highlight></figure>
...
<figure className="highlight"><Highlight>{`.relative1 {
  position: relative;
}
.relative2 {
  position: relative;
...
<Elem red id="relative2" style={{position: "relative",
    top: "-20px",
    left: "20px",
...
<Elem green id="fixed" style={{ position: "fixed",
    bottom: 0,
    right: 0,
    width: "200px",
    backgroundColor: "white",
...
<figure className="highlight"><Highlight>{`.fixed {
  position: fixed;
  bottom: 0;
  right: 0;
  width: 200px;
...
<figure className="highlight"><Highlight>{`.relative {
  position: relative;
  width: 600px;
  height: 400px;
}
...
<Elem id="relative" style={{position: "relative",
  width: "600px",
  height: "400px"}}>
  <p >
  ...
  <Elem red id="absolute" style={{ position: "absolute",
  top: "120px",
  right: 0,
  width: "300px",
  height: "200px"}}>
...
<Link to="box-sizing.html" className="nav prev">Previous</Link>
<Link to="position-example.html" className="nav next">Next</Link>
</div>
<footer>
          7 / 19
        </footer>
