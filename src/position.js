...
<div className="relative1 elem" style={{position: "relative"}}>
...
<div className="fixed elem elem-green" style={{ 
    position: "fixed",
    bottom: 0,
    right: 0,
    width: "200px",
...
<div className="relative elem" style={{
     position: "relative",
     width: "600px",
     height: "400px"
}}>
  ...
  <div className="absolute elem elem-red" style={{ position: "absolute",
    top: "120px",
    right: 0,
    width: "300px",
    height: "200px"}}>
