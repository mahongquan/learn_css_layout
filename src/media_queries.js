...
`}</style>
<figure className="highlight"><Highlight>{`@media screen and (min-width:600px) {
  nav {
    float: left;
    width: 25%;
  }
...
<Link to="percent.html" className="nav prev">Previous</Link>
<Link to="inline-block.html" className="nav next">Next</Link>
</div>
<footer>
          14 / 19
        </footer>
