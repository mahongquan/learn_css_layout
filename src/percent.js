...
`}</style>
<figure className="highlight"><Highlight>{`article img {
  float: right;
  width: 50%;
}`}</Highlight></figure>
...
<Link to="float-layout.html" className="nav prev">Previous</Link>
<Link to="media-queries.html" className="nav next">Next</Link>
</div>
<footer>
          13 / 19
        </footer>
