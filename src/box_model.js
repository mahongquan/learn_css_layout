...
<figure className="highlight"><Highlight>{`.simple {
  width: 500px;
  margin: 20px auto;
}
...
<Link to="max-width.html" className="nav prev">Previous</Link>
<Link to="box-sizing.html" className="nav next">Next</Link>
</div>
<footer>
          5 / 19
        </footer>
