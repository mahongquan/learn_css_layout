...
`}
        ...
        <div className="nav-wrapper">
          <Link className="nav prev" to="box-model.html">
            Previous
          </Link>
          <Link className="nav next" to="position.html">
            Next
          </Link>
        </div>
        <footer>6 / 19</footer>
