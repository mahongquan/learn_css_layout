...
`}</style>
<figure className="highlight"><Highlight>{`.three-column {
  padding: 1em;
  -moz-column-count: 3;
  -moz-column-gap: 1em;
  -webkit-column-count: 3;
...
<Link to="inline-block-layout.html" className="nav prev">Previous</Link>
<Link to="flexbox.html" className="nav next">Next</Link>
</div>
<footer>
          17 / 19
        </footer>
